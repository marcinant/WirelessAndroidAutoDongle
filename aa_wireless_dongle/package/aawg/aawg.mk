...
AAWG_DEPENDENCIES = dbus-cxx-custom protobuf bluez5_utils
...
define AAWG_BUILD_CMDS
    $(MAKE) $(TARGET_CONFIGURE_OPTS) PROTOC=$(HOST_DIR)/bin/protoc AAWG_BUILD_HASH=$(AAWG_BUILD_HASH) -C $(@D) aawgd aawg-obd
endef

define AAWG_INSTALL_TARGET_CMDS
    $(INSTALL) -D -m 0755 $(@D)/aawgd  $(TARGET_DIR)/usr/bin
    $(INSTALL) -D -m 0755 $(@D)/aawg-obd  $(TARGET_DIR)/usr/bin
endef
