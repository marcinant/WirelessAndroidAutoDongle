...
const STRINGS: Record<string, Entry> = {
  ...
  'obd.src.bt': { en: 'Bluetooth', pl: 'Bluetooth' },
  'obd.src.tcp': { en: 'TCP / emulator', pl: 'TCP / emulator' },
  'obd.src.demo': { en: 'Demo', pl: 'Demo' },
  'obd.tcp.help': { en: 'Connect over TCP: a wifi ELM327 clone, or the ELM327-emulator dev tool on your PC (python -m elm -n 35000).', pl: 'Połączenie po TCP: wifi ELM327 albo narzędzie ELM327-emulator na PC (python -m elm -n 35000).' },
  'obd.tcp.target': { en: 'Host:port', pl: 'Host:port' },
  'obd.demo.help': { en: 'Built-in simulator — a virtual warming-up engine with live data and a misfire fault appearing after 2 minutes. No hardware needed.', pl: 'Wbudowany symulator — wirtualny, rozgrzewający się silnik z danymi na żywo i usterką zapłonu pojawiającą się po 2 minutach. Bez sprzętu.' },
